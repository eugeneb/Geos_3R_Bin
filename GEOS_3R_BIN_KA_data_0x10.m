function [ UTC,cycle_d, kol_vo_KA, SignalToNoise, phase, Doppler, H_liter] = GEOS_3R_BIN_KA_data_0x10( data,  KAnumber)
...
if(ind>0)
    ...
    phase=GEOS_3R_BIN_bin2num(data(4*(-1+14*ind)-3:4*14*ind),'double');
